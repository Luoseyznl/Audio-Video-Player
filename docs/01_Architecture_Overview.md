...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr>
    <td style="width: 50%; border: none; text-align: center;">
      <img src="01_Architecture_Overview/architecture-0.png" alt="MP4 Structure" style="width: 100%;">
      <br>
      <em>MP4 容器结构</em>
    </td>
    <td style="width: 50%; border: none; text-align: center;">
      <img src="01_Architecture_Overview/architecture-1.png" alt="MKV Structure" style="width: 100%;">
      <br>
      <em>MKV 容器结构</em>
    </td>
  </tr>
